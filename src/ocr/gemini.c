...
static const char *parse_prompt(void) {
    return "You are an expert German supermarket receipt parsing tool. You are given text "
           ...
           "image_quality: Assess the OCR text quality as a number 0-100. "
           "100 = perfect OCR, every character clear. 50 = roughly half readable. "
           "0 = completely unreadable/garbled.\n\n"
