...
{
  return "You are german supermarket receipt parsing tool. You are given text that was extracted from the receipt photo."
  "The layout is important. Please extract"
}
